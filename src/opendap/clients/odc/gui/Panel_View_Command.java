...
//			jpanelCommand.add( jtfCommand, BorderLayout.NORTH ); 
	...
	public void vDisplayAppendLine( String sTextToAppend ){
		String sResponseTermination = opendap.clients.odc.InterprocessServer.getResponseTermination();
		if( sTextToAppend.endsWith( sResponseTermination ) ){
			sTextToAppend = sTextToAppend.substring(0, sTextToAppend.length()- sResponseTermination.length());
		}
