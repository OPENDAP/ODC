...
//                              rect.x, rect.y, rect.width, rect.height, null);
		...
		// draw nav box (1 pixel width)
		g.setColor( Color.RED );
		int iNavBox_x_offset = 10;
		int iNavBox_y_offset = 10;
		int iNavBox_w = 100;
		int iNavBox_h = iNavBox_w * view_manager.iVP_h / view_manager.iVP_w;
		int iNavBox_x = view_manager.iVP_w - iNavBox_w - iNavBox_x_offset - 2;
		int iNavBox_y = view_manager.iVP_h - iNavBox_h - iNavBox_y_offset - 2;;
	...
	void click( int x, int y ){
		if( x > iNavBox_x && x < iNavBox_x + iNavBox_w && y > iNavBox_y && y < iNavBox_y + iNavBox_h ){ // in nav box
			int iNewCenter_x = (x - iNavBox_x - 1) * view_manager.iVP_w / iNavBox_w;
			int iNewCenter_y = (y - iNavBox_y - 1) * view_manager.iVP_h / iNavBox_h;
